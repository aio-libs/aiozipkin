...
_version_path = _docs_path / '../aiozipkin/__init__.py'
...
# documentation.
#
aiozipkin_desc = ('module that adds monitor and cli capabilities'
                   'for asyncio application')
html_theme_options = {
    'description': aiozipkin_desc,
...
latex_documents = [
    (master_doc, 'aiozipkin.tex', 'aiozipkin Documentation',
...
man_pages = [
    (master_doc, 'aiozipkin', 'aiozipkin Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'aiozipkin', 'aiozipkin Documentation',
     author, 'aiozipkin', aiozipkin_desc,
     'Miscellaneous'),
]
